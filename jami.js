function encodeURIComponent(url) {
    ...
    // var newUrl = url.replace(/\%3A/g, ":").replace(/\%2F/g, "/").replace(/\%3F/g, "?").replace(/\%3D/g, "=").replace(/\%26/g, "&")
    return newUrl
}
...
window = this, window.encodeURIComponent = encodeURIComponent, window.navigator = navigator;
"use strict";
...
i.prototype.M = function (e) {
    ...
    G.prototype.v = function (e) {
        for (var t = new Buffer.from(e, encoding='base64').toString('binary'), n = [], r = 0; r < t.length - 1; r += 2)
            n.push(t.charCodeAt(r) << 8 | t.charCodeAt(r + 1));
        this.b = n
    }
    ,
    G.prototype.y = function (e) {
        for (var t = new Buffer.from(e, encoding='base64').toString('binary'), n = 66, r = [], o = 0; o < t.length; o++) {
...
console.log(get_encrypt("client_id=c3cef7c66a1843f8b3a9e6a1e3160e20&grant_type=password&timestamp=1551163837800&source=com.zhihu.web&signature=2ce508bf7f7d97569fa4a7e6edb155ebe7b6adc4&username=%2B8617681820023&password=2345678&captcha=%7B%22img_size%22%3A%5B200%2C44%5D%2C%22input_points%22%3A%5B%5B121%2C24.1875%5D%2C%5B166%2C19.1875%5D%5D%7D&lang=cn&ref_source=homepage&utm_source="))
